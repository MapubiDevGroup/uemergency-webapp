...
public class SosuserFacadeREST extends AbstractFacade<Sosuser> {
    @PersistenceContext(unitName = "EmergencyPU")
   ...
   @GET
    @Path("{name}/{firstname}/{pays}")
    @Consumes({ "application/json"})
    public void create(@PathParam("name") String name,@PathParam("firstname") String firstname,@PathParam("pays") String pays) {
    ...
    public void edit(@PathParam("id") Long id, Sosuser entity) {
        super.edit(entity);
    }
